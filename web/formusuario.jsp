<%-- 
    ...
    Created on : 22/09/2020, 03:00:33 AM
    Author     : DELL
--%>
    ...
    <div class="container-fluid animated fadeIn fast">
        <div class="row">
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                ...
                <form class="needs-validation" action="./Controlador?accion=GuardarUsuario"  enctype="multipart/form-data" method="POST" novalidate>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Nombre</label>
                            <input type="text" class="form-control" id="nombreUsuario" name="nombreUsuario" maxLength="45" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="password" class="form-control" id="precio" name="contraseña" maxLength="20" required>
                        <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                     <div class="invalid-feedback">
