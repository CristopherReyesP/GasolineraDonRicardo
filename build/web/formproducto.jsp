<%-- 
    ...
    Created on : 22/09/2020, 02:59:12 AM
    Author     : DELL
--%>
        ...
        <div class="row">
           <%@include file="menu.jsp" %>
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                ...
                <form class="needs-validation" action="Controlador?accion=GuardarProducto"  enctype="multipart/form-data" method="POST" novalidate>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Nombre:</label>
                            <input type="text" class="form-control"  name="txtNombre" placeholder="" maxLength="45" required>
                            <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío, no se aceptan nombres duplicados por lo que debe especificar tamaños</small>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="descripcionProducto" name="descripcionProducto" rows="3" maxLength="60" required></textarea>
                       <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="Minimo" name="Minimo" min="1" required>
                        <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="Maximo" name="Maximo" min="1" required>
                        <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                         <div class="invalid-feedback">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control"  name="Stock" placeholder="" min="1" required>
                      <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                      <div class="invalid-feedback">
                        Por favor introduzca stock para el producto.
                      </div>
                  </div>
                </div>
