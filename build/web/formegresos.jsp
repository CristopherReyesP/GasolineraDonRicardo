<%-- 
    Document   : formegresos
    Created on : 24/09/2020, 08:53:33 PM
    Author     : DELL
--%>
...
<%@include file="menu.jsp" %>
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom ">
                    <h1 class="h2 "> Formulario de egresos</h1>
                </div>
                <form class="needs-validation" action="Controlador?accion=GuardarEgreso"  enctype="multipart/form-data" method="POST" novalidate>
