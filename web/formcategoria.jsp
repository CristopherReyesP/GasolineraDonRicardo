<%-- 
    Document   : formcategoria.jsp
    Created on : 22/09/2020, 02:57:35 AM
    Author     : DELL
--%>
...
<%@include file="menu.jsp" %>
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom ">
                 ...
                 <form class="needs-validation" action="./Controlador?accion=GuardarCategoria"  enctype="multipart/form-data" method="POST" novalidate>
                <div class="form-group">
                    <label for="descripcionProducto">Nombre</label>
                    <input type="text" class="form-control" id="nombreproveedor" name="nombreCategoria" maxLength="45" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="descripcionProducto" name="descripcionCategoria" rows="3" maxLength="100" required></textarea>
                    <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                    <div class="invalid-feedback">
