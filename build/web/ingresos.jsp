<%-- 
    Document   : ingresos
    Created on : 24/09/2020, 03:55:52 PM
    Author     : DELL
--%>
...
<%@include file="menu.jsp" %>
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom ">
                    <h1 class="h2 ">Dashboard: Ingresos</h1>
                    <div class="btn-toolbar mb-2 mb-md-0 ">
                        <div class="btn-group mr-2 ">
                            <button type="button " class="btn btn-lg btn-outline-success " onclick="location.href='./Controlador?accion=NuevoIngreso'">
                ...
                <div class="table-responsive ">
                    <table id="datos" number-per-page="10" current-page=""  class="table table-striped table-sm ">
                        ...
                        <tbody>
                             <c:forEach var="p" items="${listaingresos}">
                            <tr>
                                <td>${p.getId_ingreso()}</td>
                                <td>${p.getFecha()}</td>
                                <td>${p.getNombreProd()}</td>
                                <td>${p.getCantidad()}</td>
                                <!-- <td>
                                    <div class="btn-group " role="group " aria-label="Basic example ">
                                        <button type="button" class="btn btn-outline-danger" onclick="location.href='./Controlador?accion=EliminarIngreso&id=${p.getId_ingreso()}'">
