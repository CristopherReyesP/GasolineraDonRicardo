<%-- 
    Document   : usuarios
    Created on : 22/09/2020, 03:01:50 AM
    Author     : DELL
--%>
        ...
        <div class="row">
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom ">
                    <h1 class="h2 ">Dashboard: Usuarios</h1>
                    <div class="btn-toolbar mb-2 mb-md-0 ">
                        <div class="btn-group mr-2 ">
                            <button type="button " class="btn btn-lg btn-outline-success " onclick="location.href='./Controlador?accion=NuevoUsuario'">
                ...
                <div class="table-responsive ">
                    <table id="datos" number-per-page="5" current-page=""  class="table table-striped table-sm ">
                        ...
                        <tbody>
                            <c:forEach var="p" items="${listausuario}">
                            <tr>
                                <td>${p.getIdUsuario()}</td>
                                <td>${p.getNombreUsuario()}</td>
                                <td>
                                    <div class="btn-group " role="group " aria-label="Basic example ">
                                        <button type="button " class="btn btn-outline-warning " onclick="location.href='./Controlador?accion=EditarUsuarior&id=${p.getIdUsuario()}'">
                                            <img src="img/icons/actualizar.png"> Actualizar
                                        </button>
                                        <button type="button " class="btn btn-outline-danger " onclick="location.href='./Controlador?accion=EliminarUsuario&id=${p.getIdUsuario()}'">
