<%-- 
    Document   : formproveedor
    Created on : 22/09/2020, 02:59:50 AM
    Author     : DELL
--%>
    ...
    <div class="container-fluid animated fadeIn fast">
        <div class="row">
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                ...
                <form class="needs-validation" action="./Controlador?accion=GuardarProveedor"  enctype="multipart/form-data" method="POST" novalidate>
                <div class="form-group">
                    <label for="descripcionProducto">Nombre</label>
                    <input type="text" class="form-control"  name="nombreproveedor" maxLength="45" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ejemplo: 2da. Ave. Zona 3, Zacapa"  name="direcproveedor" maxLength="45" required>
                    <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control"  name="telproveedor" maxLength="15" required>
                    <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                    <div class="invalid-feedback">
