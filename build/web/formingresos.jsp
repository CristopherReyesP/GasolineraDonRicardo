<%-- 
    Document   : formingresos
    Created on : 24/09/2020, 05:06:01 PM
    Author     : DELL
--%>
...
<%@include file="menu.jsp" %>
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom ">
                    <h1 class="h2 "> Formulario de ingresos</h1>
                </div>
                <form class="needs-validation" action="Controlador?accion=GuardarIngreso"  enctype="multipart/form-data" method="POST" novalidate>

                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="categoria">Producto:</label>
                        <select class="custom-select d-block w-100"  name="item_prod" required>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Campo obligatorio. No debe dejarse vacío</small>
                          <div class="invalid-feedback">
                          Por favor introduzca una cantidad valido.
                          </div>
                    </div>
