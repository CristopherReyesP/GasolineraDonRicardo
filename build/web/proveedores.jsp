<%-- 
    ...
    Created on : 22/09/2020, 03:01:15 AM
    Author     : DELL
--%>
...
<body onload="funciones()">
    <nav class="navbar navbar-dark sticky-top bg-celeste flex-md-nowrap p-0 shadow bg-primary">
        <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3ng" href="index.js`p">Don Ricardo</a>
        ...
        <div class="row">
            ...
            <main role="main " class="col-md-9 ml-sm-auto col-lg-10 px-md-4 ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom ">
                    <h1 class="h2 ">Dashboard: Proveedores</h1>
                    <div class="btn-toolbar mb-2 mb-md-0 ">
                        <div class="btn-group mr-2 ">
                            <button type="button " class="btn btn-lg btn-outline-success " onclick="location.href='./Controlador?accion=NuevoProveedor'">
                    ...
                    <table id="datos" number-per-page="5" current-page=""  class="table table-striped table-sm ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>${p.getNombre_Proveedor()}</td>
                                <td>${p.getDireccion()}</td>
                                <td>${p.getTelefono()}</td>
                                <td>
                                    <div class="btn-group " role="group " aria-label="Basic example ">
                                        <button type="button " class="btn btn-outline-warning" onclick="location.href='./Controlador?accion=EditarProveedor&id=${p.getId_proveedor()}'">
                                            <img src="img/icons/actualizar.png"> Actualizar
                                        </button>
                                        <button type="button" class="btn btn-outline-danger" onclick="location.href='./Controlador?accion=EliminarProveedor&id=${p.getId_proveedor()}'">
